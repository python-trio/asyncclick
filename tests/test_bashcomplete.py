...
async def test_chaining():
    ...
    assert await choices_without_help(cli, ['cliarg1', 'asub', '--asub-opt'], '') == []
    assert await choices_without_help(cli, ['cliarg1', 'asub', '--asub-opt', '5', 'bsub'], '-') == ['--bsub-opt']
    assert await choices_without_help(cli, ['cliarg1', 'asub', 'bsub'], '-') == ['--bsub-opt']
    assert await choices_without_help(cli, ['cliarg1', 'asub', 'csub'], '') == ['carg1', 'carg2']
    assert await choices_without_help(cli, ['cliarg1', 'bsub', 'arg1', 'csub'], '') == ['carg1', 'carg2']
...
async def test_variadic_argument_complete():
    ...
    assert await choices_without_help(entrypoint, ['subcommand', '--opt'], '') == _complete(0,0,0)
    assert await choices_without_help(entrypoint, ['subcommand', 'whatever', '--opt'], '') == _complete(0,0,0)
    assert await choices_without_help(entrypoint, ['subcommand', 'whatever', '--opt', 'abc'], '') == []
